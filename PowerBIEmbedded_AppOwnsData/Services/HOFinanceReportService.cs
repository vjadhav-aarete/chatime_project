...
{
    public class HOFinanceReportService : IEmbedService
    {
        ...
        private static readonly string ReportId = ConfigurationManager.AppSettings["HOFinanceReport"];
