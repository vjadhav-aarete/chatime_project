...
{
    public class HelpReportService : IEmbedService
    {
        ...
        private static readonly string ReportId = ConfigurationManager.AppSettings["HelpReport"];
