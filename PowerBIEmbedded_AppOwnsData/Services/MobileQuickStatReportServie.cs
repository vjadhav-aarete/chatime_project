...
{
    public class MobileQuickStatReportServie :IEmbedService
    {
        ...
        private static readonly string ReportId = ConfigurationManager.AppSettings["MobileQuickStatID"];
        ...
        public MobileQuickStatReportServie()
        {
