...
{
    public class MobileQuickStatLFLReportService :IEmbedService
    {
        ...
        private static readonly string ReportId = ConfigurationManager.AppSettings["MobileQuickStatLFLID"];
