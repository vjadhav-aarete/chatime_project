...
{
    public class FinanceMLView : IEmbedService
    {
        ...
        private static readonly string ReportId = ConfigurationManager.AppSettings["plmultilocationview"];
