...
{
    public class MobileDailyLabourReportService :IEmbedService
    {
        ...
        private static readonly string ReportId = ConfigurationManager.AppSettings["MobileDailyLabourAnalysis"];
        ...
        public MobileDailyLabourReportService()
        {
