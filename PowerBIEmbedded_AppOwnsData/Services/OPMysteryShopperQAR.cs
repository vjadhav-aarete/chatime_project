...
{
    public class OPMysteryShopperQAR : IEmbedService
    {
        ...
        private static readonly string ReportId = ConfigurationManager.AppSettings["mysteryShopperQAR"];
