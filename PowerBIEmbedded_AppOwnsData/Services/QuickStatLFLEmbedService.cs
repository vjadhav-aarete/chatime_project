...
{
    public class QuickStatLFLEmbedService : IEmbedService
    {
        ...
        private static readonly string ReportId = ConfigurationManager.AppSettings["quickstatLFLreportId"];
        ...
        public QuickStatLFLEmbedService()
        {
