...
{
    public class HOMarketingReportService : IEmbedService
    {
        ...
        private static readonly string ReportId = ConfigurationManager.AppSettings["HOMarketingReport"];
        ...
        public HOMarketingReportService()
        {
